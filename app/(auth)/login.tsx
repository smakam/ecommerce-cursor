...
// Google client ID from the web app
...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // For demo purposes, you can still provide a fallback login option
      if (process.env.NODE_ENV === "development") {
        Alert.alert(
          "Backend Connection Error",
          "Would you like to use simulated login for testing?",
          [
            {
              text: "Cancel",
              style: "cancel",
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.footer}>
            ...
            <Link href={{ pathname: "(auth)/register" } as any} asChild>
              <TouchableOpacity>
